...
# #     shape_dist['distance_km'] = shape_dist['shape_dist_traveled'] / 1000
...
#     # -------------------------------------------------------
#     # 1) RENOMEAR TEMPORARIAMENTE para os nomes genéricos
#     # -------------------------------------------------------
#     rename_map = {
#         f'shape_dist_traveled_{plan_name}': 'shape_dist_traveled',
#         f'dist_traveled_stops_{plan_name}': 'dist_traveled_stops',
#         f'result_{plan_name}': 'result'
#     }

#     # Se o plan_name vier como "PLANO DE OFERTA", substitui para o sufixo correto
#     if plan_name.upper().startswith("PLANO"):
#         if "OFERTA" in plan_name.upper():
#             rename_map = {
#                 'shape_dist_traveled_POferta': 'shape_dist_traveled',
#                 'dist_traveled_stops_POferta': 'dist_traveled_stops',
#                 'result_POferta': 'result'
#             }
#         else:
#             rename_map = {
#                 'shape_dist_traveled_POperação': 'shape_dist_traveled',
#                 'dist_traveled_stops_POperação': 'dist_traveled_stops',
#                 'result_POperação': 'result'
#             }
...
#     # -------------------------------------------------------
#     # 2) VOLTAR A RENOMEAR para os sufixos (output final)
#     # -------------------------------------------------------
#     if plan_name.upper().startswith("PLANO"):
#         if "OFERTA" in plan_name.upper():
#             suffix = "POferta"
...
#         on=['pattern_id', 'period', 'day_type'],
#         how='outer',
#         suffixes=('_POferta', '_POperação')  # <--- CORRIGIDO aqui
#     )

#     # substitui "POperacao" pelo acento correto, caso exista
#     merged_all.columns = [
#         col.replace('_POperacao', '_POperação')
#         for col in merged_all.columns
#     ]
...
# #     diff_poferta_pct = (total_vkm_poferta / vkm_contrato)
# #     diff_poperacao_pct = (total_vkm_poperacao / vkm_contrato)
...
#     end_date=None,
#     vkm_contrato=None,
#     gtfs_offer_name=None,
#     gtfs_operation_name=None
# ):
#     vkm_poferta_df = calculate_vkm(gtfs_POferta, start_date, end_date)
#     vkm_poperacao_df = calculate_vkm(gtfs_POperacao, start_date, end_date)
