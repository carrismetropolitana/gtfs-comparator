...
if ask_export("📊 Queres exportar o ficheiro principal de resultados?"):
    save_to_excel(
        excel_file_path,
        alerts_df,
        grand_total_df,
...
if ask_export("📄 Queres exportar a sequência de paragens?"):
...
if ask_export("📄 Queres exportar o total de circulações e VKM?"):
